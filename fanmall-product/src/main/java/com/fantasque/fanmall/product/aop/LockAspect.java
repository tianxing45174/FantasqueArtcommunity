package com.fantasque.fanmall.product.aop;

import com.fantasque.fanmall.product.annotation.Lock;
import com.fantasque.fanmall.product.annotation.ReadLock;
...
public class LockAspect {
     ...
     * @return
     */
    @Around("@annotation(com.fantasque.fanmall.product.annotation.Lock)")
     ...
     * @return
     */
    @Around("@annotation(com.fantasque.fanmall.product.annotation.ReadLock)")
     ...
     * @return
     */
    @Around("@annotation(com.fantasque.fanmall.product.annotation.WriteLock)")
