package com.fantasque.fanmall.member.aop;

import com.fantasque.common.vo.MemberResponseVo;
import com.fantasque.fanmall.member.annotation.Lock;
import com.fantasque.fanmall.member.annotation.ReadLock;
import com.fantasque.fanmall.member.annotation.WriteLock;
...
public class LockAspect {
     ...
     * @return
     */
    @Around("@annotation(com.fantasque.fanmall.member.annotation.Lock)")
     ...
     * @return
     */
    @Around("@annotation(com.fantasque.fanmall.member.annotation.ReadLock)")
     ...
     * @return
     */
    @Around("@annotation(com.fantasque.fanmall.member.annotation.WriteLock)")
