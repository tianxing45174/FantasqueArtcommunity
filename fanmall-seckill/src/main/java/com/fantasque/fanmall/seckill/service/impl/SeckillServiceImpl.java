package com.fantasque.fanmall.seckill.service.impl;
...
import com.fantasque.fanmall.seckill.feign.CouponFeignService;
import com.fantasque.fanmall.seckill.feign.ProductFeignService;
import com.fantasque.fanmall.seckill.interceptor.LoginUserInterceptor;
import com.fantasque.fanmall.seckill.service.SeckillService;
import com.fantasque.fanmall.seckill.to.SeckillSkuRedisTo;
import com.fantasque.fanmall.seckill.vo.SeckillSessionWithSkusVo;
import com.fantasque.fanmall.seckill.vo.SkuInfoVo;
    ...
    public List<SeckillSkuRedisTo> getCurrentSeckillSkus() {
        ...
        try (Entry entry = SphU.entry("seckillSkus")) {
            ...
            for (String key : keys) {
                ...
                if (currentTime >= startTime && currentTime <= endTime) {
                    //2、获取这个秒杀场次需要的所有商品信息
                    //redisTemplate.opsForHash().size(SESSION__CACHE_PREFIX);
                    //range = lrange
